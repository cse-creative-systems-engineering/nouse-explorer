...
contextBridge.exposeInMainWorld('nouse', {
  ...
  research: {
    ...
    getModelMetrics: (modelId: string) => ipcRenderer.invoke('research:model-metrics', modelId) as Promise<Array<{ metric: string; value: number; method: string; source_url: string }>>,
